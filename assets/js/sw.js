...
// 
const SHELL_CACHE = "shell-8.4.0--v1--sw/www/";
...
const ASSETS_CACHE = "assets--v1--sw/www/";

// The cache for regular content, which will be invalidated every time you make a new build.
const CONTENT_CACHE = "content--2019-07-17T08:14:10+00:00--sw/www/";
...
const ICON_FONT = "/www/assets/icomoon/style.css";
...
const SHELL_FILES = [
  "/www/assets/bower_components/fontfaceobserver/fontfaceobserver.standalone.js",
  "/www/assets/js/hydejack-8.4.0.js",
  "/www/assets/css/hydejack-8.4.0.css",
  "/www/assets/img/swipe.svg",
  ICON_FONT,
  /**/ GOOGLE_FONTS /**/,
];

const ASSET_FILES = [
  /**/ "/www/assets/img/sidebar-bg.jpg" /**/,
  /**/ "/www/assets/icons/icon.png" /**/,
  /**/
];
...
const CONTENT_FILES = [
  "/www/",
  "/www/?utm_source=homescreen",
  "/www/assets/manifest.json",
  /**/
];

const NOT_FOUND_PAGE = "/www/404.html";
...
function isSameSite({ origin, pathname }) {
  return origin.startsWith("https://cts48584.github.io") && pathname.startsWith("/www");
}
...
async function fromNetwork(e, request) {
  ...
  if (isSameSite(url) || hasSWParam) {
    const isAsset = url.pathname.startsWith("/www/assets");
...
async function onActivate(e) {
  ...
  return Promise.all(
    keys
      ...
      .filter(key => key.endsWith("sw/www/"))
      // Delete old caches
